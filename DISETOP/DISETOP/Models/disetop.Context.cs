...
public partial class DISETOPEntities : DbContext
{
    ...
    public virtual int sp_EditarPagos(string codigoPago, string codigoEmpleado, string cuentaBancaria, string diasAPagar, Nullable<decimal> monto, Nullable<System.DateTime> fechaDePago, string comentario)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_EditarPagos", codigoPagoParameter, codigoEmpleadoParameter, cuentaBancariaParameter, diasAPagarParameter, montoParameter, fechaDePagoParameter, comentarioParameter);
    }
